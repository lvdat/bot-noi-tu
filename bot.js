...
if (!fs.existsSync(reportWordsPath)) {
    console.log(`[WARNING] File report-words.json doesn't exist. Creating...`)
    fs.writeFileSync(reportWordsPath, JSON.stringify(emptyData))
} else {
    console.log(`[OK] File report-words.json exist.`)
}
